...
| 3A. Competition structure | implemented | Competition identity, Category-grouped recoverable roster editor, automatic/supplied numbering, V3 Category/Muqarrar start template with V1/V2 compatibility, and stable participant identities | Draft, accordion, paste, legacy/template, identity, and workbook round-trip tests pass |
