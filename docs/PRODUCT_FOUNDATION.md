...
| 3A. Competition structure | implemented | Competition identity, recoverable roster editor, automatic/supplied numbering, V1-compatible competition Template V2, and stable participant identities | Draft, paste, template, identity, and workbook round-trip tests pass |
