...
Current UI correction addendum: [Replay UX fix plan](REPLAY_UX_FIX_PLAN.md),
including browser evidence, continuous-play confirmation and revised layout gates.
The source findings below are historical; consult current integration checkpoints.
